...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            var data = _axios2.default.get('localhost:3000/api/todo').then(function (res) {
                return res;
            }).catch(function (err) {
                return err;
            });
        ...
        value: function handleClick(index) {
            var newList = this.state.todolist.filter(function (user, i) {
                return i !== index;
            });
            this.setState({
                todolist: newList
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_todo2.default, {
                    onForcusSubmit: function onForcusSubmit(data) {
                        return _this2.handleSubmit(data);
                    },
                    onForcusChange: function onForcusChange(data) {
                        return _this2.handleChange(data);
                    }
                }),
                _react2.default.createElement(_todoList2.default, { onForcusClick: function onForcusClick(index) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "form",
                        { className: "form-group", onSubmit: function onSubmit(data) {
                                return _this2.props.onForcusSubmit(data);
                            } },
                        _react2.default.createElement("input", { type: "text", id: "todo", onChange: function onChange(event) {
                                return _this2.props.onForcusChange(event);
                            } }),
                        _react2.default.createElement(
                            "button",
                            null,
...
var TodoList = function (_React$Component) {
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            ...
            var renderItem = this.props.todolist.map(function (node, index) {
                return _react2.default.createElement(
                    "li",
                    { key: index, onClick: function onClick() {
                            return _this2.props.onForcusClick(index);
